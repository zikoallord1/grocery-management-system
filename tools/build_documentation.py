...
def build_pdf(path: Path, title: str, screenshots: list[tuple[str, Path]], detailed: bool) -> None:
    ...
    if detailed:
        sections = [
            ("طريقة الاستخدام الأساسية", "يُدخل المستخدم العملية مرة واحدة، ثم يربط النظام أثرها التشغيلي والمالي والمخزني والتقارير ذات الصلة حسب الوظيفة المتاحة."),
            ("المبيعات والمشتريات", "أنشئ الفاتورة، اختر العميل أو المورد عند الحاجة، اختر الصنف والوحدة والكمية والسعر، ثم احفظ العملية. الكميات المخزنية تعتمد على الوحدة الأساسية ومعامل التحويل الخاص بالصنف."),
            ("الوحدات والعبوات", "يمكن تعريف أكثر من وحدة للصنف نفسه. مثال: 1 كرتون = 20 حبة لصنف، بينما يمكن أن يكون كرتون صنف آخر = 24 حبة. تحفظ العملية الوحدة ومعامل التحويل المستخدم وقت الإدخال."),
            ("الباركود", "يمكن استخدام قارئ الباركود بالكاميرا في شاشة المبيعات لإضافة الصنف بسرعة، مع دعم تكرار المسح."),
            ("المالية والذمم", "الدفع النقدي والمحفظة والتحويل البنكي مرتبطة بالحساب النقدي المناسب، بينما الائتمان يظهر كذمة على العميل أو المورد حسب العملية."),
            ("المرتجعات", "المرتجع يعكس أثر المخزون والحركة المالية مع المحافظة على مرجع الفاتورة الأصلية، ولا يعتمد على حذف العملية المالية."),
            ("الإغلاق والنسخ الاحتياطي", "يوفر النظام صيانة يومية تلقائية تتضمن إغلاق اليوم ونسخة احتياطية عند نجاح الإجراء، مع تسجيل حالة العملية."),
